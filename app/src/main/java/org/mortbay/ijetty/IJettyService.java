...
import org.mortbay.ijetty.handler.SinglePageApplicationHandler;
...
//                                System.currentTimeMillis());
                        ...
                        Notification notification = new NotificationCompat.Builder(IJettyService.this, TAG)
    ...
    public void onStart(Intent intent, int startId) {
        ...
        try {
            ...
            wakeLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK, "IJetty::WakelockTag");
            wakeLock.acquire();
    ...
    protected void configureHandlers() {
        if (server != null) {
            ...
            handlers.setHandlers(new Handler[]{new SinglePageApplicationHandler()});
